...
class Chain:
  ...
  def validnonce(self , block, hash):
  ...
  def proof_of_work(self,block):
    ...
    return self.validnonce(block, hash)
  ...
  def create_origin_block(self):
    fake_previoush = hashlib.sha256()
    fake_previoush.update(''.encode('utf-8'))
    origin = Block("Origin", fake_previoush)
